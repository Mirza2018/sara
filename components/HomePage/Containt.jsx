...
const Containt = () => {
    return (
        <section  className="relative  md:pt-[100px] ">
    ...
    md:me-[50px] md:gap-[100px]  gap-[20px]  md:pt-[100px]">
        <div  className="relative flex items-end   sm:pb-16 md:justify-center  md:mx-0 mx-auto ">
            ...
            <div  className="">
                <Image  className="md:w-screen w-[82vw] rounded-lg shadow-lg scale-110" objectFit="cover"  src={dog1} alt="" />
            </div>
        ...
        {/* sm:px-6 lg:px-8 sm:py-16 lg:py-24 */}
                ...
                <div  className="flex items-center justify-center text-center">
                    <div  className="flex justify-center items-center flex-col text-[#302F51]">
                        <h2  className="text-[34px] md:text-fluid-lg-title xl:text-[62px] font-bold flex flex-shrink-0 md:mb-[12px] mb-[20px] md:mx-0 mx-[20px]">Add Your Profile</h2>
                        <p  className="text-[22px] md:text-fluid-small-title font-semibold md:mb-[30px] mb-[20px]">Find new Friends Nearby </p>
                <p  className="text-[16px] md:text-fluid-base text-justify mx-6">
                Become a part of the Woof Spot community! Create a profile for your pup 
    ...
    <div  className="grid grid-cols-1 lg:grid-cols-2 md:ms-[183px] md:me-[119px]   md:gap-[100px] gap-[40px] 2xl:mt-[210px] xl:mt-[120px] mt-[20px]">
        ...
        <div  className="flex items-center justify-center text-center">
            <div  className="flex justify-center items-center flex-col text-[#302F51]">
                <h2  className="md:text-fluid-lg-title text-[40px] font-bold flex flex-shrink-0 mb-[30px] text-center md:mx-0 mx-[24px]">Connecting Paws, Building Community</h2>
                {/* <p  className="text-fluid-small-title font-semibold mb-[30px]">Find new Friends Nearby </p> */}


                <p  className="md:text-fluid-base text-[16px]  text-justify mb-[20px] md:mx-0 mx-[20px]">
                For over twenty years, I lived in the same neighborhood, but I didn’t know a single neighbor.
                 Life was busy, and connections just didn’t happen. Then, three years ago, things changed when the 
                 tiniest, goofiest puppy came into my life. Neighbors began to stop and chat during our walks,
                  and playdates filled our calendar. It was a revelation—the love of dogs has the power to bring 
                  people together.
                </p>
                <p  className="md:text-fluid-base text-[16px]  text-justify mb-[20px] md:mx-0 mx-[20px]">
                Dogs bring so much joy into our lives, and they enrich our communities in ways we often overlook. 
                They help us forge connections, share smiles, and create bonds that last. In recognizing the incredible 
                value dogs bring, Woof Spot was born. 
                </p>
                <p  className="md:text-fluid-base text-[16px] text-justify md:mx-0 mx-[20px]">

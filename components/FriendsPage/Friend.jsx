    ...
    return (
        <div className='grid md:grid-cols-3 bg-white 
            ...
            <div className='text-center flex justify-center items-center flex-col'> 
                ...
                {/* Profile Information */}
                <p className='text-fluid-lg-title-1 font-semibold text-[#302F51]'>Murphy Bear</p>
                <p className='text-fluid-lg-title-1 font-semibold text-[#302F51]'>Age: 2</p>
                <p className='text-fluid-lg-title-1 font-semibold flex justify-center items-center gap-2 text-[#302F51]'>
                    <PiMapPinAreaFill className='text-[#F88D58]'/> Houston, TX
                </p>
            </div>

            <div className='flex justify-top items-center flex-col gap-1 md:mb-0 mb-[40px]'>
                <p className='bg-[#F88D58] rounded-full py-4 px-6 text-white font-bold '>1</p>
                ...
                <div className='flex justify-center items-center gap-[11px]'>
                    ...
                    <p className='font-semibold text-fluid-lg-title-2 my-[27px]'>1.2 Miles</p>
                </div>
